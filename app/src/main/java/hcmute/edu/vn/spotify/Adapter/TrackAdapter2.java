...
import hcmute.edu.vn.spotify.Activity.TrackVideo;
...
public class TrackAdapter2 extends RecyclerView.Adapter<TrackAdapter2.TrackViewHolder > implements Filterable {
    // declare the context
    ...
    public TrackAdapter2(Context pContext){
    ...
    public TrackViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.videocomponent, parent, false);
        return new TrackAdapter2.TrackViewHolder(view);
    }
...
//                    PlayMedia(MainActivity.track);
                    Intent topic_music = new Intent(pContext, TrackVideo.class);
                    //Create bundle to send data to next activity
                    Bundle bundle = new Bundle();
                    bundle.putSerializable("object_topic", track);
    ...
    public class TrackViewHolder extends RecyclerView.ViewHolder {
        ...
        public TrackViewHolder(@NonNull View itemView) {
            ...
            trackLayout = itemView.findViewById(R.id.videoLayout);
        }
    }
